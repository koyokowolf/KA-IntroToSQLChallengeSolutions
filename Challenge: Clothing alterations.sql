...
/* Step 1: Use ALTER to add a 'price' column to the table. Then select all the columns in each row to  see what your table looks like now.*/
...
INSERT INTO clothes (type, design, price) VALUES ( "high heels", "red leather", 40);// MAKE type and design YOUR OWN
